                                    ...
                                    <div class="note-item all-notes note-personal" id="income-form">
                                        <div class="note-inner-content rounded border-success">
                                            <div class="row mb-2">
                                                    ...
                                                    <div class="input-group mb-4">
                                                        <div class="input-group-prepend">
                                                          <span class="input-group-text">$</span>
                                                            ...
                                                            <input type="text" placeholder="Amount expected:" class="form-control" aria-label="Amount (to the nearest dollar)">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <textarea style="max-height: 200px;" placeholder="Description (optional):" name="" id="" cols="30" rows="5" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="text-right">
                                                        <button class="btn btn-primary mb-2">Add Income</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
